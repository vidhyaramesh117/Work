...
//                Snackbar.make(v,"Chat",Snackbar.LENGTH_LONG).setAction("Action",null).show();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener()
        {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                ...
                if (item_id == R.id.pers_chat)
                {
                    loadFragment(new personal_chat_Fragment());
                }
                if (item_id == R.id.grp_chat)
                {
                    loadFragment(new Group_chat_Fragment() );
                }
                if (item_id == R.id.comm)
                {
                    loadFragment(new community_Fragment());
                }
                return true;
            }
